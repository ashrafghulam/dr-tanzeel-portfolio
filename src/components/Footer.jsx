    ...
    <footer className="bg-text py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-white/60 text-sm mt-2">{doctor.taglineEnglish}</p>

          <p className="text-white/40 text-sm mt-6 font-heading italic">
            {"\u0939\u0930 \u092C\u091A\u094D\u091A\u093E \u0938\u094D\u0935\u0938\u094D\u0925 \u0930\u0939\u0947"}{" "}
            {"\u{1F64F}"}
          </p>
          ...
          <div className="border-t border-white/10 mt-8 pt-6">
            <p className="text-white/40 text-sm">
              &copy; 2025 {doctor.name}. All rights reserved.
            </p>
          </div>
        </div>
      </div>
